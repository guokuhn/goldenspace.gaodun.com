                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center space-x-1 text-gray-600 mb-3 group">
                                    ...
                                    />
                                    <span className="text-sm group-hover:text-accent-600 transition-colors">
                                        {live.viewers} 人观看
                                    </span>
                                </div>
                                <div className="flex flex-wrap gap-1 mb-3">
                                    ...
                                    {live.tags.map((tag, idx) => (
                                        <span
                                            key={idx}
                                            className="text-xs bg-blue-50 text-blue-600 px-2.5 py-1 rounded-full font-medium hover:bg-blue-100 transition-colors"
                                        >
                                            {" "}
                                            {tag}
                                        </span>
                                ...
                                <button className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-2.5 rounded-lg font-medium hover:from-blue-600 hover:to-blue-700 hover:shadow-lg transition-all">
                                    {" "}
                                    进入直播间
                                </button>
                            </div>
